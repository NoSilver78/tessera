...
> **Wichtig:** Codex validierte das **UX-Modell**, NICHT die Mehrparteien-**Isolations**-Frage (§8.1) — die läuft separat (Isolations-Machbarkeits-Workflow). Deren Go/No-Go ist der **übergeordnete** Gate: fällt es negativ aus (Ein-Instanz-Isolation nicht wasserdicht), ändert sich die Gesamtarchitektur, nicht nur die UI.
