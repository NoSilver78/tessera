...
> **Isolations-Gate ENTSCHIEDEN:** Codex validierte das **UX-Modell**; die Mehrparteien-**Isolations**-Frage (§8.1) wurde separat quellcode-verifiziert beantwortet (`spike/reports/tessera-multitenant-isolation-feasibility-2026-07-01.md`): echte Mieter-Isolation auf **einer** Instanz = **NO-GO** (render_template/History/Automation-Kontext/Camera-Proxy/Admin-Bypass lecken lautlos). **Empfehlung: getrennte HA-Instanzen pro Einheit.** → Tesseras Scope ist damit **Ein-Haushalt-/Intra-Instanz-RBAC**, NICHT Mandantentrennung. Dieses UX-Modell bleibt für diesen (geklärten) Scope voll gültig; die Owner-Architektur-Entscheidung steht aus.
